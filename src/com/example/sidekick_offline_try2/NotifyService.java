...
public class NotifyService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		NOTIFICATION = intent.getIntExtra("listingId", 1234);
	...
	public static void cancelRem(int lid){
		mNM.cancel(lid);
	}
	@Override
	...
	private void showNotification() {
		...
		CharSequence title = showName;
		// This is the icon to use on the notification
		int icon = R.drawable.reminder_icon;
		// This is the scrolling text of the notification
		CharSequence text = "Your favourite show is airing ...";		
...
//		        .setContentText("Your favourite show is airing ... ");
//
//		
...
//		mNotificationManager.notify(listingId, mBuilder.getNotification());
		...
		editor.putBoolean("onnotify", true);
		editor.commit();
