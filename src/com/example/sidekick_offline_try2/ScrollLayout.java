...
public class ScrollLayout extends LinearLayout {
    ...
    public int mLastX, mLastScroll, mScrollX;
    ...
    private int objHeight;
     int centerIndex;
    private Drawable rightShadow, leftShadow,arr;
    int finalX;
    ...
    public ScrollLayout(Context context, AttributeSet attrs) {
       ...
       /// leftShadow = getContext().getResources().getDrawable(R.drawable.left_shadow);
        arr = getContext().getResources().getDrawable(R.drawable.line);
        ...
        String className = a.getString(R.styleable.ScrollLayout_labelerClass);
        if (className == null) {
    ...
    protected void onFinishInflate() {
        ...
        Log.e("SCREENWIDTH", String.valueOf(displayWidth));
        ...
        Log.v("No.of CHILDREN", String.valueOf(childCount));
        Log.v("CENTER",String.valueOf(centerIndex));
        Log.v("objWidth",String.valueOf(objWidth));
        //mid = (centerIndex)*objWidth;
    ...
    public void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mInitialOffset = objWidth*(centerIndex+1)-w/2;
        Log.v("W:,OLD:",String.valueOf(childrenWidth)+", "+String.valueOf(w));
    ...
    protected void dispatchDraw(Canvas canvas) {
       ...
       // Log.v("GETSCROLLX", String.valueOf(getScrollX()));
        arr.setBounds(getScrollX()+getWidth()/2-2, 0, getScrollX()+getWidth()/2+2, getHeight());
        arr.draw(canvas);
    ...
    private void setTime(long time, int loops) {
        ...
        if (loops>2 || currelem.getStartTime() <= time && currelem.getEndTime() >= time) {
            ...
            int left = (getChildCount()/2)*objWidth-getScrollX()+objWidth/2;
            Log.v("CENTER TIME :", String.valueOf(center));
            Log.v("LEFT TIME :", String.valueOf(left));
    ...
    protected void reScrollTo(int x, int y, boolean notify) {
    	...
    	if (minTime!=-1 && notify && scrollDiff<0) {
            double center = getWidth()/2.0;
            int left = (getChildCount()/2)*objWidth-scrollX+objWidth/2;
    ...
    private void fling(int velocityX) {
        ...
        if (getChildCount() > 0) {
            ...
            Log.i("curr + finalX : ", String.valueOf(currentTime)+" + " + String.valueOf(mScroller.getFinalX()));
        }
